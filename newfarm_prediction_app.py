...
N = st.number_input("Nitrogen content (N)", min_value=0.0, value=90.0, key="N")
P = st.number_input("Phosphorus content (P)", min_value=0.0, value=42.0, key="P")
K = st.number_input("Potassium content (K)", min_value=0.0, value=43.0, key="K")
ph = st.number_input("pH level of soil", min_value=0.0, max_value=14.0, value=6.5, key="ph")
temperature = st.number_input("Average Temperature (°C)", value=27.5, key="temperature")
humidity = st.number_input("Average Humidity (%)", value=80.0, key="humidity")
rainfall = st.number_input("Rainfall (mm)", value=110.0, key="rainfall")
